...
public class PositionTracking implements Runnable {
    ...
    public PositionTracking(String yEncoder1Name, double yEncoder1DistanceXFromCenter, double yEncoder1DistanceYFromCenter,
        ...
        yEncoder1 = (DcMotorEx) MecanumChassis.hardwareMap.dcMotor.get(yEncoder1Name);
        ...
        yEncoder2 = (DcMotorEx) MecanumChassis.hardwareMap.dcMotor.get(yEncoder2Name);
        ...
        xEncoder = (DcMotorEx) MecanumChassis.hardwareMap.dcMotor.get(xEncoderName);
...
//        yEncoder1Velocity = yEncoder1.getVelocity();
//        yEncoder2Velocity = yEncoder2.getVelocity();
//        xEncoderVelocity = xEncoder.getVelocity();
//    }
//
//    @Override
//    public void run() {
